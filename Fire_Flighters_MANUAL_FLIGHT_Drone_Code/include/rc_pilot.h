...
static uint8_t RX_Pins[RC_CHANS] = {15, 16, 17, 6, 8, 1}; // r o p b g y
...
struct rc_t
{
  ...
  int16_t Prev_ROLL_filter;
  int16_t Prev_PITCH_filter;
  int16_t Prev_THR_filter;
  int16_t Prev_YAW_filter;

  int16_t Same_Count;
  int16_t Same_Count_Kill_Switch;
